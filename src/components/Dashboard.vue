      ...
      <aside class="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col">
        ...
        <div class="p-4 border-t border-gray-200">
          <ul class="space-y-2">
            ...
            <li>
              <a href="#" @click.prevent="handleLogout" class="flex items-center space-x-2 px-3 py-2 text-gray-700 hover:bg-gray-50 rounded-md">
...
import TopThemesChart from './TopThemesChart.vue';
